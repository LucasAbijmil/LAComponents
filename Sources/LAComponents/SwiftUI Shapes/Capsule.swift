...
public extension Capsule {
  ...
  /// Fills the background of the `Capsule` and strokes it halfway from the inside and outside.
  ///
  /// Therefore if you define a size to the `Capsule`, it will increase its frame if you increase the width of the line.
  ///
  /// - Parameters:
  ...
  /// Fills the background of the `Capsule` and strokes it from the inside.
  ///
  /// Therefore if you define a size to the `Capsule`, it won't increase its frame even if you increase the line width.
  ///
  /// - Parameters:
  ///   - color: The color to fill the capsule.
  ///   - strokeColor: The color of the edge.
