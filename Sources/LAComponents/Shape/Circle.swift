...
public extension Circle {
  ...
  /// Fills the background of the ``Circle`` and strokes it halfway from the inside and outside. Therefore if you define a size to the ``Circle``, it will increase its frame if you increase the width of the line.
  ///
  /// - Parameters:
