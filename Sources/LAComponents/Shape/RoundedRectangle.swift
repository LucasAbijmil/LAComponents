...
public extension RoundedRectangle {
  ...
  /// Fills the background of the `RoundedRectangle` and strokes it from the inside.
  ///
  /// Therefore if you define a size to the `RoundedRectangle`, it won't increase its frame even if you increase the line width.
  ///
  /// - Parameters:
  ///   - color: The color to fill the rounded rectangle.
  ///   - strokeColor: The color of the edge.
